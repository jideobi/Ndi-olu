  ...
  return (
    <div>
      ...
      <textarea
        ...
        className={`min-h-36 w-full resize-y rounded-xl border bg-white px-4 py-3 text-sm font-medium leading-6 text-slate-800 outline-none transition placeholder:text-slate-400 focus:ring-2 ${
          error
